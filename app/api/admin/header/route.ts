...
function cleanSettings(input: Partial<HeaderSettings>): HeaderSettings {
  ...
  return {
    ...
    accountMenuDonationsEnabled: input.accountMenuDonationsEnabled !== false,
    accountMenuQurbanEnabled: input.accountMenuQurbanEnabled !== false,
    accountMenuSponsorshipsEnabled: input.accountMenuSponsorshipsEnabled !== false,
    accountMenuWellsEnabled: input.accountMenuWellsEnabled !== false,
    accountMenuProjectsEnabled: input.accountMenuProjectsEnabled !== false,
    accountPageAccentColor: safeColor(input.accountPageAccentColor, defaultHeaderSettings.accountPageAccentColor),
    ...
    mobileMenuTitleColor: safeColor(input.mobileMenuTitleColor, defaultHeaderSettings.mobileMenuTitleColor),
    mobileMenuTitleSize: safeNumber(input.mobileMenuTitleSize, 12, 24, defaultHeaderSettings.mobileMenuTitleSize),
    mobileMenuDescriptionColor: safeColor(input.mobileMenuDescriptionColor, defaultHeaderSettings.mobileMenuDescriptionColor),
    mobileMenuDescriptionSize: safeNumber(input.mobileMenuDescriptionSize, 9, 18, defaultHeaderSettings.mobileMenuDescriptionSize),
    mobileMenuActiveTextColor: safeColor(input.mobileMenuActiveTextColor, defaultHeaderSettings.mobileMenuActiveTextColor),
