...
function normalizeDonationOptionTextDesign(
  ...
  return {
    ...
    textTransform: commerceChoice(
      ...
      ["none", "uppercase", "lowercase", …5588 tokens truncated…750, suggested: [1, 2, 3, 4], customAmountEnabled: false, desktop: { ...defaultProjectDesign }, mobile: { ...defaultProjectDesign, cardWidth: 330, cardPadding: 20, cardRadius: 16, titleSize: 24, imageHeight: 205 } },
